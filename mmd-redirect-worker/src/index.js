...
function renderPublicBlackcardPage(request) {
  ...
  const benefitsHref = `${url.pathname}${query}#blackcard-benefits`;
  const personalHref = `${url.pathname}${query}#personal-brief`;
  ...
  const assets = {
    ...
    hero: "https://cdn.prod.website-files.com/68f879d546d2f4e2ab186e90/6a2e89da3f9feeabc206fa8c_SIGIL_Wall.webp",
    review: "https://cdn.prod.website-files.com/68f879d546d2f4e2ab186e90/6a3ee66fc6eae04d54df2899_Yuki%20Review%2001.webp",
    tart: "https://cdn.prod.website-files.com/68f879d546d2f4e2ab186e90/6a2352a8163bca43972997c3_TartStart-02.webp",
    booking: "https://cdn.prod.website-files.com/68f879d546d2f4e2ab186e90/6a206dbfc18b7cdfd2b230ea_Booking03.webp",
...
<meta name="description" content="MMD Privé Black Card privileges page. Priority access, super new model updates, 24-hour care and personal briefing with Per.">
...
<main id="mmd-blackcard" class="mbc" data-mmd-page="${PUBLIC_BLACKCARD_PAGE}" data-status-api="/api/blackcard/status" data-profile-url="/sigil/member/profile">
  <section class="mbc-hero" aria-label="Black Card privileges">
    <img class="mbc-hero-img" src="${assets.hero}" alt="Black Card privileges">
    ...
    <div class="mbc-shell mbc-hero-shell">
      <nav class="mbc-top" aria-label="Black Card navigation">
        ...
        <div class="mbc-pills"><span>Priority access</span><span>Super new model</span><span>Personal care</span></div>
      </nav>
      <div class="mbc-hero-grid">
        <div class="mbc-copy">
          <p class="mbc-kicker">BLACK CARD PRIVILEGES</p>
          <h1>สิทธิ์ที่ดีที่สุด<br><span>ของสมาชิก MMD</span></h1>
          <p class="mbc-lead">Black Card คือระดับการดูแลที่เปิดให้สมาชิกเข้าถึงตัวเลือกมากกว่า เร็วกว่า และละเอียดกว่าการเป็นสมาชิกปกติ</p>
          <p>เหมาะสำหรับลูกค้าที่ต้องการให้งานบริการเป็นเรื่องง่าย ไม่ต้องไล่ถามเอง ไม่ต้องรอข้อมูลช้า และสามารถบรีฟความต้องการส่วนตัวกับ Per ได้อย่างละเอียดตั้งแต่ก่อนเริ่มเลือกนายแบบ</p>
          <div class="mbc-actions"><a class="mbc-btn primary" href="${benefitsHref}">ดูสิทธิ์ Black Card</a><a class="mbc-btn ghost" href="${personalHref}">บรีฟส่วนตัวกับ Per</a></div>
        </div>
        <aside class="mbc-hero-panel"><span>Black Card care</span><strong>เข้าถึงก่อน ดูแลก่อน และบรีฟได้ละเอียดกว่า</strong><p>สมาชิก Black Card ได้รับการดูแลแบบ priority ทั้งการแนะนำ model, update รูปใหม่, คิวบริการ และการปรึกษาความต้องการแบบส่วนตัว</p></aside>
      </div>
    </div>
  </section>

  <section id="blackcard-benefits" class="mbc-shell mbc-status">
    <article class="mbc-panel"><p class="mbc-kicker">BLACK CARD BENEFITS</p><h2>สิทธิ์ที่ได้จริง</h2><p>Black Card ไม่ควรรู้สึกเหมือนด่านตรวจ แต่ควรรู้สึกเหมือนมีคนดูแลหลังบ้านให้ทั้งหมด ตั้งแต่การเลือกนายแบบ การรับข่าวสารใหม่ การจัดคิว ไปจนถึงการบรีฟความต้องการที่ละเอียดและเป็นส่วนตัว</p><div class="mbc-doctrine"><article><span>Exclusive access</span><strong>เข้าถึงนายแบบที่แพ็กเกจปกติไม่มี</strong><p>เห็นตัวเลือกพิเศษและ profile ที่ไม่ได้เปิดในแพ็กเกจทั่วไป</p></article><article><span>First look</span><strong>รับรูปและข่าวสาร super new model ก่อนใคร</strong><p>มีโอกาสเห็น model ใหม่ก่อนเปิดให้สมาชิกทั่วไปเลือก</p></article><article><span>Priority service</span><strong>ได้สิทธิ์ใช้บริการก่อนเมื่อคิวพร้อม</strong><p>เมื่อมีช่วงเวลาที่เหมาะสม ระบบจะดูแล Black Card ก่อนตามความเหมาะสม</p></article></div></article>
    <div class="mbc-signal-grid"><article><span>24H</span><strong>ดูแลต่อเนื่องตลอดวัน</strong><p>ส่งคำถาม ฝาก brief หรือแจ้งความต้องการได้ง่ายขึ้น ไม่ต้องเริ่มเล่าใหม่ทุกครั้ง</p></article><article><span>Per</span><strong>ปรึกษาส่วนตัวกับ Per</strong><p>บรีฟสไตล์ ความต้องการ ข้อจำกัด และความสบายใจได้ละเอียดกว่า</p></article><article><span>Private note</span><strong>จำ preference ของคุณ</strong><p>MMD ช่วยเก็บ pattern ความชอบ เพื่อแนะนำให้ตรงขึ้นในครั้งต่อไป</p></article></div>
  </section>

  <section class="mbc-shell mbc-split" id="personal-brief">
    <div class="mbc-text"><p class="mbc-kicker">PERSONAL BRIEF</p><h2>บรีฟกับ Per ให้ละเอียดก่อนเลือก</h2><p>สมาชิก Black Card สามารถคุยความต้องการกับ Per แบบส่วนตัวได้มากกว่า เช่น mood ที่ต้องการ บุคลิกนายแบบที่ชอบ ข้อควรระวัง เวลา สถานที่ และรายละเอียดที่อยากให้ MMD ช่วยคัดให้ก่อนส่งตัวเลือก</p><div class="mbc-stack"><div><span>Preference</span><strong>ระบุสเปกและสไตล์ที่ชอบได้ละเอียด</strong></div><div><span>Context</span><strong>ให้ MMD เข้าใจสถานการณ์ก่อนแนะนำ</strong></div><div><span>Comfort</span><strong>ลดการคุยซ้ำและช่วยให้เลือกง่ายขึ้น</strong></div></div></div>
    <figure class="mbc-image"><img src="${assets.tart}" alt="Personal Black Card briefing"><figcaption><span>Personal brief</span><strong>ยิ่งบรีฟชัด ระบบยิ่งเลือกให้ตรง</strong></figcaption></figure>
  </section>

  <section class="mbc-shell mbc-split reverse">
    <figure class="mbc-image tall"><img src="${assets.card}" alt="Black Card identity"></figure>
    <div class="mbc-text"><p class="mbc-kicker">THE CARD</p><h2>มากกว่า package ปกติ</h2><p>Black Card ถูกออกแบบให้เป็นระดับดูแลที่กว้างกว่า premium membership ปกติ จุดสำคัญไม่ใช่ความลับ แต่คือการเข้าถึงตัวเลือกมากขึ้น การได้ข้อมูลเร็วขึ้น และการมีคนช่วยจัดการรายละเอียดให้จริง</p><div class="mbc-stack"><div><span>Model access</span><strong>เห็นตัวเลือกที่กว้างกว่า</strong></div><div><span>Update speed</span><strong>ได้รับข่าวสารและรูปใหม่ไวกว่า</strong></div><div><span>Service memory</span><strong>ประวัติและ preference ต่อเนื่องกว่า</strong></div></div></div>
  </section>

  <section class="mbc-shell mbc-split">
    <div class="mbc-text"><p class="mbc-kicker">SERVICE STANDARD</p><h2>ดูแลให้จบกว่าเดิม</h2><p>Black Card ช่วยให้การใช้บริการไม่ต้องเริ่มจากศูนย์ทุกครั้ง MMD สามารถช่วยจำ preference, ช่วยคัดตัวเลือก, ช่วยแจ้ง update และช่วยประสานจังหวะที่เหมาะกับลูกค้ามากขึ้น</p><div class="mbc-doctrine"><article><span>Concierge</span><strong>ดูแล 24 ชม.</strong><p>รับเรื่องและประสานต่อให้เป็นระบบมากขึ้น</p></article><article><span>Priority</span><strong>ใช้บริการก่อนใคร</strong><p>เมื่อมีคิวและ model ที่เหมาะสม จะถูกจัดลำดับดูแลก่อน</p></article><article><span>Clarity</span><strong>ข้อมูลชัดก่อนตัดสินใจ</strong><p>ช่วยลดการถามซ้ำและทำให้เลือกง่ายขึ้น</p></article></div></div>
    <figure class="mbc-image"><img src="${assets.booking}" alt="Black Card service standard"></figure>
  </section>

  <section class="mbc-shell mbc-split reverse">
    <figure class="mbc-image"><img src="${assets.profile}" alt="Member profile and membership history"></figure>
    <div class="mbc-text"><p class="mbc-kicker">MEMBER PROFILE</p><h2>สิทธิ์ผูกกับ profile ของคุณ</h2><p>ข้อมูลสมาชิก ประวัติการใช้บริการ preference และสิทธิ์ Black Card จะถูกผูกกับ member profile เพื่อให้การดูแลครั้งต่อไปต่อเนื่องขึ้น ไม่ต้องเริ่มคุยใหม่ทุกครั้ง</p><div class="mbc-profile-panel"><div><span>Status</span><strong id="mbcDemoStatus">Black Card care</strong></div><div><span>Access</span><strong id="mbcDemoPoints">Exclusive model</strong></div><div><span>Brief</span><strong id="mbcDemoApproval">Personal with Per</strong></div></div><div class="mbc-actions"><a id="mbcProfileBtn" class="mbc-btn primary" href="${profileHref}">Open Member Profile</a><button id="mbcCopyProfileBtn" class="mbc-btn ghost" type="button">Copy Profile Link</button></div></div>
  </section>

  <section class="mbc-shell mbc-network">
    <img src="${assets.network}" alt="MMD Privé private network">
    <div><p class="mbc-kicker">MMD PRIVÉ NETWORK</p><h2>เข้าถึง network ได้ลึกกว่า</h2><p>Black Card ช่วยให้สมาชิกเห็นตัวเลือกที่กว้างกว่า ได้รับข่าวสาร super new model เร็วกว่า และมีคนช่วยอ่านความต้องการก่อนจัดตัวเลือกให้เหมาะกับแต่ละเคส</p><div class="mbc-network-grid"><article><span>01</span><strong>All model reach</strong><p>เข้าถึงนายแบบที่อยู่นอกแพ็กเกจปกติ</p></article><article><span>02</span><strong>Super new model</strong><p>เห็นรูปและข่าวสารใหม่ก่อนใคร</p></article><article><span>03</span><strong>Priority queue</strong><p>ได้รับการจัดลำดับดูแลก่อนตามความเหมาะสม</p></article><article><span>04</span><strong>Personal brief</strong><p>คุยกับ Per เพื่อให้ MMD เข้าใจความต้องการจริง</p></article></div></div>
  </section>

  <section class="mbc-shell mbc-process"><p class="mbc-kicker">HOW IT HELPS</p><h2>Black Card ช่วยอะไรบ้าง</h2><div class="mbc-process-grid"><article><span>1</span><strong>บอกความต้องการ</strong><p>ส่ง brief หรือคุยกับ Per เพื่อให้ระบบเข้าใจ style ที่ต้องการ</p></article><article><span>2</span><strong>คัดตัวเลือกให้</strong><p>MMD ช่วยดู model ที่เหมาะกว่า ไม่ใช่ส่งรายชื่อแบบสุ่ม</p></article><article><span>3</span><strong>แจ้ง update ก่อน</strong><p>รับรูป ข่าว และ super new model ก่อนสมาชิกทั่วไป</p></article><article><span>4</span><strong>ดูแลต่อเนื่อง</strong><p>หลังใช้งาน preference จะชัดขึ้นและครั้งต่อไปจะเลือกง่ายขึ้น</p></article></div></section>

  <section class="mbc-shell mbc-final"><div><p class="mbc-kicker">BLACK CARD PRIVILEGE</p><h2>เข้าถึงมากกว่า ดูแลมากกว่า เลือกง่ายกว่า</h2><p>Black Card คือสิทธิ์ดูแลระดับสูงของ MMD Privé ข้อมูลการชำระเงินและ profile ยังต้องตรวจตามระบบเพื่อความถูกต้อง แต่หน้านี้ไม่มีปุ่มจ่ายเงิน ไม่มีการเปิดสิทธิ์ทันที และไม่มีการ redirect ไป checkout</p><p>Black Card is not purchased into existence. It is reviewed, verified, and quietly recognized.</p></div><div class="mbc-actions"><a class="mbc-btn primary" href="${benefitsHref}">ดูสิทธิ์อีกครั้ง</a><a class="mbc-btn ghost" href="${aliasHref}">Open Alias</a></div></section>
  <footer class="mbc-shell mbc-footer"><strong>MMD BLACK CARD</strong><span>© 2026 MMD Privé. Black Card privilege page.</span></footer>
</main>
...
function blackcardStyles() {
  return `@import url('https://fonts.googleapis.com/css2?family=Inter:wght@500;600;700;800;900&family=IBM+Plex+Sans+Thai:wght@400;500;600;700;800&display=swap');:root{color-scheme:dark}*{box-sizing:border-box}html{background:#050404;scroll-behavior:smooth}body{margin:0;min-height:100vh;background:#050404;color:#faf2df;font-family:"IBM Plex Sans Thai",Inter,"Segoe UI",Arial,sans-serif;text-rendering:geometricPrecision;-webkit-font-smoothing:antialiased}.mbc{--gold:#d8b15f;--gold2:#f4dd95;--cream:#fff6df;--text:#faf2df;--muted:rgba(250,242,223,.74);--dim:rgba(250,242,223,.48);--line:rgba(216,177,95,.25);--soft:rgba(255,255,255,.12);--panel:rgba(12,11,9,.78);overflow:hidden;background:radial-gradient(circle at 14% 0%,rgba(216,177,95,.16),transparent 28rem),radial-gradient(circle at 92% 14%,rgba(111,75,22,.2),transparent 28rem),#050404}.mbc-shell{width:min(100% - 28px,1180px);margin:auto}.mbc-hero{position:relative;min-height:680px;display:flex;isolation:isolate;overflow:hidden}.mbc-hero-img{position:absolute;inset:0;z-index:-3;width:100%;height:100%;object-fit:cover;object-position:center;filter:saturate(1.08) contrast(1.06) brightness(.84)}.mbc-shade{position:absolute;inset:0;z-index:-2;background:linear-gradient(180deg,rgba(5,4,4,.2) 0%,rgba(5,4,4,.54) 48%,rgba(5,4,4,.96) 100%),linear-gradient(90deg,rgba(5,4,4,.86) 0%,rgba(5,4,4,.26) 100%)}.mbc-hero-shell{display:flex;flex-direction:column;justify-content:space-between;padding:20px 0 32px}.mbc-top{display:flex;align-items:center;gap:11px;flex-wrap:wrap}.mbc-mark{width:52px;height:52px;display:grid;place-items:center;border:0;border-radius:0;color:inherit;background:transparent;text-decoration:none;box-shadow:none;overflow:visible}.mbc-mark img{width:52px;height:52px;object-fit:contain;filter:drop-shadow(0 10px 24px rgba(216,177,95,.22))}.mbc-brand{display:grid;gap:2px}.mbc-brand span,.mbc-kicker{margin:0;color:var(--gold2);font-family:Inter,"IBM Plex Sans Thai",sans-serif;font-size:.66rem;letter-spacing:.18em;text-transform:uppercase;font-weight:800}.mbc-brand strong{font-family:Inter,"IBM Plex Sans Thai",sans-serif;font-size:1.05rem;line-height:1.05;letter-spacing:-.02em}.mbc-pills{display:none;width:100%;gap:7px;flex-wrap:wrap}.mbc-pills span{min-height:28px;display:inline-flex;align-items:center;justify-content:center;padding:7px 10px;border:1px solid var(--soft);border-radius:999px;color:var(--muted);background:rgba(10,9,8,.52);backdrop-filter:blur(16px);font-family:Inter,"IBM Plex Sans Thai",sans-serif;font-size:.64rem;letter-spacing:.08em;text-transform:uppercase;font-weight:800}.mbc-hero-grid{display:grid;grid-template-columns:1fr;gap:14px;align-items:end;padding-top:190px}.mbc h1{max-width:900px;margin:10px 0 14px;font-family:"IBM Plex Sans Thai",Inter,sans-serif;font-size:clamp(2.62rem,12.5vw,4.35rem);line-height:.98;letter-spacing:-.045em;font-weight:800;color:var(--cream)}.mbc h1 span{color:var(--gold2)}.mbc h2{margin:8px 0 12px;font-family:"IBM Plex Sans Thai",Inter,sans-serif;font-size:clamp(2rem,8.4vw,3.8rem);line-height:1.04;letter-spacing:-.04em;font-weight:800}.mbc p{margin:0;color:var(--muted);font-size:1rem;line-height:1.76;font-weight:500}.mbc-lead{color:rgba(250,242,223,.92)!important;font-size:clamp(1.06rem,3.9vw,1.34rem)!important;line-height:1.58!important;font-weight:700!important;max-width:820px}.mbc-hero-panel,.mbc-panel,.mbc-signal-grid article,.mbc-stack div,.mbc-doctrine article,.mbc-profile-panel div,.mbc-network-grid article,.mbc-process-grid article,.mbc-final,.mbc-image,.mbc-result{border:1px solid var(--line);background:linear-gradient(145deg,rgba(255,255,255,.07),rgba(255,255,255,.012)),var(--panel);box-shadow:0 24px 70px rgba(0,0,0,.28);backdrop-filter:blur(18px)}.mbc-hero-panel{display:grid;gap:8px;padding:16px;border-radius:22px}.mbc-hero-panel span,.mbc-result span,.mbc-stack span,.mbc-doctrine span,.mbc-profile-panel span,.mbc-network-grid span,.mbc-signal-grid span,.mbc-process-grid span,.mbc-image figcaption span{color:var(--dim);font-family:Inter,"IBM Plex Sans Thai",sans-serif;font-size:.66rem;letter-spacing:.13em;text-transform:uppercase;font-weight:800}.mbc-hero-panel span{color:var(--gold2)}.mbc-hero-panel strong{font-size:1.18rem;line-height:1.28;font-weight:800}.mbc-actions{display:grid;grid-template-columns:1fr;gap:9px;margin-top:18px}.mbc-btn{min-height:48px;width:100%;display:inline-flex;align-items:center;justify-content:center;text-align:center;padding:13px 18px;border-radius:999px;border:1px solid var(--line);text-decoration:none;cursor:pointer;-webkit-tap-highlight-color:transparent;font-family:Inter,"IBM Plex Sans Thai",sans-serif;font-size:.88rem;font-weight:850;letter-spacing:.01em;line-height:1.08}.mbc-btn.primary{color:#171006;background:linear-gradient(135deg,#f7e6a8,#bd8730);box-shadow:0 16px 42px rgba(216,177,95,.22)}.mbc-btn.ghost{color:var(--text);background:rgba(255,255,255,.055)}.mbc-btn:active{transform:scale(.985)}.mbc-status,.mbc-split,.mbc-process{display:grid;gap:16px}.mbc-status,.mbc-split,.mbc-process,.mbc-final{margin-top:16px}.mbc-panel,.mbc-final{border-radius:26px;padding:18px;display:grid;gap:16px}.mbc-status h2{font-size:clamp(2.1rem,8.8vw,3.8rem);letter-spacing:-.04em}.mbc-form{display:grid;gap:8px}.mbc-form label{color:var(--dim);font-family:Inter,"IBM Plex Sans Thai",sans-serif;font-size:.72rem;letter-spacing:.12em;text-transform:uppercase;font-weight:800}.mbc-form div{display:grid;grid-template-columns:1fr;gap:8px}.mbc-form input{width:100%;min-height:50px;padding:0 15px;color:var(--text);border:1px solid var(--soft);border-radius:999px;outline:none;background:rgba(255,255,255,.07);font-size:1rem}.mbc-form input::placeholder{color:rgba(250,242,223,.42)}.mbc-result{border-radius:18px;padding:14px;display:grid;gap:6px}.mbc-result.is-approved{border-color:rgba(244,221,149,.72);background:linear-gradient(145deg,rgba(216,177,95,.18),rgba(255,255,255,.02)),var(--panel)}.mbc-result strong,.mbc-stack strong,.mbc-doctrine strong,.mbc-profile-panel strong,.mbc-network-grid strong,.mbc-signal-grid strong,.mbc-process-grid strong{font-size:1rem;line-height:1.42;font-weight:800}.mbc-signal-grid,.mbc-stack,.mbc-doctrine,.mbc-profile-panel,.mbc-network-grid,.mbc-process-grid{display:grid;grid-template-columns:1fr;gap:10px}.mbc-signal-grid article,.mbc-stack div,.mbc-doctrine article,.mbc-profile-panel div,.mbc-network-grid article,.mbc-process-grid article{border-radius:18px;padding:15px;display:grid;gap:6px}.mbc-text{display:flex;flex-direction:column;justify-content:center;min-width:0}.mbc-image{margin:0;overflow:hidden;border-radius:26px;min-height:300px;position:relative}.mbc-image img{width:100%;height:100%;min-height:300px;object-fit:cover;filter:saturate(1.06) contrast(1.04)}.mbc-image.tall img{min-height:420px}.mbc-image figcaption{position:absolute;left:14px;right:14px;bottom:14px;display:grid;gap:4px;padding:12px;border:1px solid var(--line);border-radius:16px;background:rgba(5,4,4,.7);backdrop-filter:blur(16px)}.mbc-network{position:relative;overflow:hidden;min-height:600px;border-radius:26px;border:1px solid var(--line);display:flex;align-items:end;isolation:isolate;margin-top:16px}.mbc-network>img{position:absolute;inset:0;z-index:-2;width:100%;height:100%;object-fit:cover;object-position:center;filter:saturate(1.05) contrast(1.03) brightness(.92)}.mbc-network:after{content:"";position:absolute;inset:0;z-index:-1;background:linear-gradient(180deg,rgba(5,4,4,.16) 0%,rgba(5,4,4,.9) 78%),linear-gradient(90deg,rgba(5,4,4,.82),rgba(5,4,4,.18))}.mbc-network>div{width:100%;padding:18px}.mbc-footer{display:flex;justify-content:space-between;gap:18px;flex-wrap:wrap;margin-top:28px;padding:24px 0 40px;border-top:1px solid rgba(255,255,255,.1);color:rgba(250,242,223,.45)}.mbc-footer strong{color:var(--text)}@media(min-width:700px){.mbc-shell{width:min(100% - 40px,1180px)}.mbc-hero{min-height:760px}.mbc-hero-img{object-position:center;filter:saturate(1.1) contrast(1.06) brightness(.9)}.mbc-shade{background:linear-gradient(90deg,rgba(5,4,4,.86) 0%,rgba(5,4,4,.55) 48%,rgba(5,4,4,.12) 100%),linear-gradient(180deg,rgba(5,4,4,.08) 0%,rgba(5,4,4,.86) 100%)}.mbc-hero-shell{padding:28px 0 46px}.mbc-top{flex-wrap:nowrap}.mbc-mark,.mbc-mark img{width:58px;height:58px}.mbc-pills{display:flex;width:auto;margin-left:auto;justify-content:flex-end}.mbc-hero-grid{grid-template-columns:minmax(0,1fr) minmax(260px,340px);gap:28px;padding-top:240px}.mbc h1{font-size:clamp(4.1rem,8.5vw,7.35rem);line-height:.94}.mbc-actions,.mbc-form div{display:flex;flex-wrap:wrap}.mbc-btn{width:auto;min-width:164px}.mbc-form input{flex:1 1 260px}.mbc-signal-grid,.mbc-doctrine,.mbc-profile-panel{grid-template-columns:repeat(3,minmax(0,1fr))}.mbc-network-grid,.mbc-process-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.mbc-panel,.mbc-final,.mbc-network>div{padding:24px}}@media(min-width:980px){.mbc-status,.mbc-split{grid-template-columns:repeat(2,minmax(0,1fr));gap:22px;align-items:stretch}.mbc-status{grid-template-columns:minmax(0,1.25fr) minmax(300px,.75fr)}.mbc-signal-grid{grid-template-columns:1fr}.mbc-split.reverse .mbc-image{order:0}.mbc-network{min-height:680px}.mbc-network>div{width:min(720px,100%);padding:34px}.mbc-process-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.mbc-final{grid-template-columns:minmax(0,1fr) auto;align-items:center}}`;
}
