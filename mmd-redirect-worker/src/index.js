...
<main id="mmd-blackcard" class="mbc" data-mmd-page="${PUBLIC_BLACKCARD_PAGE}" data-status-api="/api/blackcard/status" data-profile-url="/sigil/member/profile">
  ...
  <section class="mbc-shell mbc-split" id="personal-brief">
    ...
    <figure class="mbc-image"><img src="${assets.review}" alt="Personal Black Card briefing"><figcaption><span>Personal brief</span><strong>ยิ่งบรีฟชัด ระบบยิ่งเลือกให้ตรง</strong></figcaption></figure>
  </section>
  ...
  <section class="mbc-shell mbc-split">
    ...
    <figure class="mbc-image"><img src="${assets.pay}" alt="Black Card service standard"></figure>
  </section>
