...
function blackcardStyles() {
  return `:root{color-scheme:dark}*{box-sizing:border-box}html{background:#050404;scroll-behavior:smooth}body{margin:0;min-height:100vh;background:#050404;color:#faf2df;font-family:Inter,"Avenir Next","Segoe UI","Noto Sans Thai",Arial,sans-serif}.mbc{--gold:#d8b15f;--gold2:#f4dd95;--text:#faf2df;--muted:rgba(250,242,223,.68);--dim:rgba(250,242,223,.44);--line:rgba(216,177,95,.24);--soft:rgba(255,255,255,.12);--panel:rgba(12,11,9,.78);overflow:hidden;background:radial-gradient(circle at 14% 0%,rgba(216,177,95,.16),transparent 28rem),radial-gradient(circle at 92% 14%,rgba(111,75,22,.22),transparent 28rem),#050404}.mbc-shell{width:min(100% - 22px,1180px);margin:auto}.mbc-hero{position:relative;min-height:720px;display:flex;isolation:isolate;overflow:hidden}.mbc-hero-img{position:absolute;inset:0;z-index:-3;width:100%;height:100%;object-fit:cover;object-position:center top;filter:saturate(1.08) contrast(1.04) brightness(1.08)}.mbc-shade{position:absolute;inset:0;z-index:-2;background:linear-gradient(180deg,rgba(5,4,4,.1) 0%,rgba(5,4,4,.52) 44%,rgba(5,4,4,.96) 100%),linear-gradient(90deg,rgba(5,4,4,.82) 0%,rgba(5,4,4,.24) 100%)}.mbc-hero-shell{display:flex;flex-direction:column;justify-content:space-between;padding:18px 0 34px}.mbc-top{display:flex;align-items:center;gap:12px;flex-wrap:wrap}.mbc-mark{width:44px;height:44px;display:grid;place-items:center;border:1px solid var(--line);border-radius:14px;color:#171006;background:linear-gradient(135deg,#f6e39e,#b98731);text-decoration:none;box-shadow:0 14px 38px rgba(216,177,95,.22)}.mbc-mark span{font-size:.78rem;font-weight:950}.mbc-brand{display:grid;gap:2px}.mbc-brand span,.mbc-kicker{margin:0;color:var(--gold2);font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;font-weight:850}.mbc-brand strong{font-size:1.08rem;line-height:1.05}.mbc-pills{width:100%;display:flex;gap:7px;flex-wrap:wrap}.mbc-pills span{min-height:28px;display:inline-flex;align-items:center;padding:7px 10px;border:1px solid var(--soft);border-radius:999px;color:var(--muted);background:rgba(10,9,8,.58);backdrop-filter:blur(16px);font-size:.66rem;letter-spacing:.1em;text-transform:uppercase;font-weight:800}.mbc-hero-grid{display:grid;grid-template-columns:1fr;gap:16px;align-items:end;padding-top:230px}.mbc h1{margin:10px 0 12px;font-size:clamp(3.1rem,16vw,4.9rem);line-height:.84;letter-spacing:-.08em;font-weight:850}.mbc h1 span{color:var(--gold2)}.mbc h2{margin:8px 0 12px;font-size:clamp(2rem,10vw,4.8rem);line-height:.92;letter-spacing:-.07em;font-weight:830}.mbc p{margin:0;color:var(--muted);font-size:.95rem;line-height:1.65}.mbc-lead{color:rgba(250,242,223,.86)!important;font-size:clamp(1.05rem,3.8vw,1.42rem)!important}.mbc-hero-panel,.mbc-panel,.mbc-signal-grid article,.mbc-stack div,.mbc-doctrine article,.mbc-profile-panel div,.mbc-network-grid article,.mbc-process-grid article,.mbc-final,.mbc-image,.mbc-result{border:1px solid var(--line);background:linear-gradient(145deg,rgba(255,255,255,.07),rgba(255,255,255,.014)),var(--panel);box-shadow:0 24px 70px rgba(0,0,0,.3);backdrop-filter:blur(18px)}.mbc-hero-panel{display:grid;gap:8px;padding:16px;border-radius:22px}.mbc-hero-panel span,.mbc-result span,.mbc-stack span,.mbc-doctrine span,.mbc-profile-panel span,.mbc-network-grid span,.mbc-signal-grid span,.mbc-process-grid span,.mbc-image figcaption span{color:var(--dim);font-size:.68rem;letter-spacing:.12em;text-transform:uppercase;font-weight:800}.mbc-hero-panel span{color:var(--gold2)}.mbc-hero-panel strong{font-size:1.28rem;line-height:1.12}.mbc-actions{display:grid;grid-template-columns:1fr;gap:9px;margin-top:18px}.mbc-btn{min-height:46px;width:100%;display:inline-flex;align-items:center;justify-content:center;padding:12px 16px;border-radius:999px;border:1px solid var(--line);text-decoration:none;cursor:pointer;-webkit-tap-highlight-color:transparent;font-size:.86rem;font-weight:850;letter-spacing:.03em}.mbc-btn.primary{color:#171006;background:linear-gradient(135deg,#f6e39e,#b98731);box-shadow:0 16px 42px rgba(216,177,95,.22)}.mbc-btn.ghost{color:var(--text);background:rgba(255,255,255,.055)}.mbc-main,.mbc-status,.mbc-split,.mbc-process{display:grid;gap:16px}.mbc-status,.mbc-split,.mbc-process,.mbc-final{margin-top:16px}.mbc-panel,.mbc-final{border-radius:30px;padding:18px;display:grid;gap:16px}.mbc-form{display:grid;gap:8px}.mbc-form label{color:var(--dim);font-size:.72rem;letter-spacing:.12em;text-transform:uppercase;font-weight:800}.mbc-form div{display:grid;grid-template-columns:1fr;gap:8px}.mbc-form input{width:100%;min-height:46px;padding:0 14px;color:var(--text);border:1px solid var(--soft);border-radius:999px;outline:none;background:rgba(255,255,255,.065)}.mbc-result{border-radius:16px;padding:14px;display:grid;gap:6px}.mbc-result.is-approved{border-color:rgba(244,221,149,.72);background:linear-gradient(145deg,rgba(216,177,95,.18),rgba(255,255,255,.02)),var(--panel)}.mbc-result strong,.mbc-stack strong,.mbc-doctrine strong,.mbc-profile-panel strong,.mbc-network-grid strong,.mbc-signal-grid strong,.mbc-process-grid strong{font-size:1rem;line-height:1.25}.mbc-signal-grid,.mbc-stack,.mbc-doctrine,.mbc-profile-panel,.mbc-network-grid,.mbc-process-grid{display:grid;grid-template-columns:1fr;gap:10px}.mbc-signal-grid article,.mbc-stack div,.mbc-doctrine article,.mbc-profile-panel div,.mbc-network-grid article,.mbc-process-grid article{border-radius:16px;padding:14px;display:grid;gap:5px}.mbc-text{display:flex;flex-direction:column;justify-content:center;min-width:0}.mbc-image{margin:0;overflow:hidden;border-radius:30px;min-height:320px;position:relative}.mbc-image img{width:100%;height:100%;min-height:320px;object-fit:cover;filter:saturate(1.06) contrast(1.04)}.mbc-image.tall img{min-height:440px}.mbc-image figcaption{position:absolute;left:14px;right:14px;bottom:14px;display:grid;gap:4px;padding:12px;border:1px solid var(--line);border-radius:16px;background:rgba(5,4,4,.7);backdrop-filter:blur(16px)}.mbc-network{position:relative;overflow:hidden;min-height:620px;border-radius:30px;border:1px solid var(--line);display:flex;align-items:end;isolation:isolate;margin-top:16px}.mbc-network>img{position:absolute;inset:0;z-index:-2;width:100%;height:100%;object-fit:cover;object-position:center;filter:saturate(1.05) contrast(1.03) brightness(.9)}.mbc-network:after{content:"";position:absolute;inset:0;z-index:-1;background:linear-gradient(180deg,rgba(5,4,4,.16) 0%,rgba(5,4,4,.9) 78%),linear-gradient(90deg,rgba(5,4,4,.82),rgba(5,4,4,.18))}.mbc-network>div{width:100%;padding:18px}.mbc-footer{display:flex;justify-content:space-between;gap:18px;flex-wrap:wrap;margin-top:28px;padding:24px 0 40px;border-top:1px solid rgba(255,255,255,.1);color:rgba(250,242,223,.45)}.mbc-footer strong{color:var(--text)}@media(min-width:700px){.mbc-shell{width:min(100% - 32px,1180px)}.mbc-hero{min-height:780px}.mbc-hero-img{object-position:center;filter:saturate(1.1) contrast(1.04) brightness(1.12)}.mbc-shade{background:linear-gradient(90deg,rgba(5,4,4,.88) 0%,rgba(5,4,4,.54) 48%,rgba(5,4,4,.12) 100%),linear-gradient(180deg,rgba(5,4,4,.08) 0%,rgba(5,4,4,.86) 100%)}.mbc-hero-shell{padding:28px 0 48px}.mbc-top{flex-wrap:nowrap}.mbc-pills{width:auto;margin-left:auto;justify-content:flex-end}.mbc-hero-grid{grid-template-columns:minmax(0,1fr) minmax(260px,340px);gap:28px;padding-top:260px}.mbc h1{font-size:clamp(4.6rem,10vw,8.6rem)}.mbc-actions,.mbc-form div{display:flex;flex-wrap:wrap}.mbc-btn{width:auto;min-width:160px}.mbc-form input{flex:1 1 260px}.mbc-signal-grid,.mbc-doctrine,.mbc-profile-panel{grid-template-columns:repeat(3,minmax(0,1fr))}.mbc-network-grid,.mbc-process-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.mbc-panel,.mbc-final,.mbc-network>div{padding:24px}}@media(min-width:980px){.mbc-status,.mbc-split{grid-template-columns:repeat(2,minmax(0,1fr));gap:22px;align-items:stretch}.mbc-status{grid-template-columns:minmax(0,1.25fr) minmax(300px,.75fr)}.mbc-signal-grid{grid-template-columns:1fr}.mbc-split.reverse .mbc-image{order:0}.mbc-network{min-height:680px}.mbc-network>div{width:min(720px,100%);padding:34px}.mbc-process-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.mbc-final{grid-template-columns:minmax(0,1fr) auto;align-items:center}}`;
}
