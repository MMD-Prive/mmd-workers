...
function renderPublicHallPage(request) {
  const query = new URL(request.url).search || "";
  const html = `<!doctype html><html lang="th"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><title>MMD Privé | Public Hall</title><meta name="description" content="MMD Privé Public Hall is a browse-first, access-later public surface for discovering the MMD Privé world before entering private access."><style>:root{color-scheme:dark}*{box-sizing:border-box}body{margin:0;min-height:100vh;background:#050404;color:#fff7e8;font-family:Inter,"Segoe UI","Noto Sans Thai",Arial,sans-serif}.public-hall{min-height:100vh;padding:24px;background:radial-gradient(circle at 16% 12%,rgba(214,176,95,.18),transparent 30%),linear-gradient(135deg,#050404 0%,#100d0a 48%,#050404 100%)}.public-hall__wrap{width:min(1100px,100%);margin:0 auto;display:grid;gap:18px}.public-hall__hero{min-height:58vh;display:grid;align-content:end;padding:clamp(28px,6vw,64px);border:1px solid rgba(216,177,95,.22);border-radius:28px;background:linear-gradient(110deg,rgba(8,7,6,.88),rgba(8,7,6,.52)),url(https://cdn.prod.website-files.com/68f879d546d2f4e2ab186e90/6a2e89da3f9feeabc206fa8c_SIGIL_Wall.webp) center/cover;box-shadow:0 32px 110px rgba(0,0,0,.45)}.public-hall__kicker{margin:0 0 12px;color:#f4dd95;font-size:12px;font-weight:900;letter-spacing:.18em;text-transform:uppercase}.public-hall h1{margin:0;max-width:820px;font-size:clamp(48px,10vw,104px);line-height:.9;letter-spacing:-.055em}.public-hall__lead{max-width:760px;margin:20px 0 0;color:rgba(255,247,232,.78);font-size:clamp(16px,2.4vw,20px);line-height:1.75}.public-hall__grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.public-hall__card{min-height:190px;padding:22px;border:1px solid rgba(216,177,95,.16);border-radius:22px;background:rgba(255,255,255,.045);box-shadow:0 18px 54px rgba(0,0,0,.24)}.public-hall__card span{display:block;color:#f4dd95;font-size:11px;font-weight:900;letter-spacing:.16em;text-transform:uppercase}.public-hall__card strong{display:block;margin-top:12px;font-size:24px;line-height:1.1}.public-hall__card p{margin:10px 0 0;color:rgba(255,247,232,.72);font-size:14px;line-height:1.7}.public-hall__actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:24px}.public-hall__action{min-height:48px;display:inline-flex;align-items:center;justify-content:center;padding:0 18px;border-radius:999px;text-decoration:none;font-weight:850}.public-hall__action--gold{color:#150f07;background:linear-gradient(135deg,#f7e6a8,#bd8730)}.public-hall__action--ghost{color:#fff7e8;border:1px solid rgba(216,177,95,.28);background:rgba(255,255,255,.06)}@media (max-width:760px){.public-hall{padding:12px}.public-hall__hero{border-radius:22px;min-height:64vh;padding:26px 18px}.public-hall__grid{grid-template-columns:1fr}.public-hall__card{min-height:auto}}</style></head><body><main class="public-hall" data-mmd-page-shell="public-hall"><div class="public-hall__wrap"><section class="public-hall__hero"><p class="public-hall__kicker">MMD PRIVÉ PUBLIC HALL</p><h1>Public Hall</h1><p class="public-hall__lead">Browse first. Access later. This is the public orientation hall for MMD Privé: a calm place to understand the world, choose the right lane, and continue only when the private access path makes sense.</p><div class="public-hall__actions"><a class="public-hall__action public-hall__action--gold" href="/trust/inme${query}">Enter Trust Path</a><a class="public-hall__action public-hall__action--ghost" href="/member/membership${query}">View Membership</a></div></section><section class="public-hall__grid" aria-label="Public Hall guide"><article class="public-hall__card"><span>Browse first</span><strong>See the public world before deciding.</strong><p>Use the Hall to understand MMD Privé without being pushed into member login or payment shortcuts.</p></article><article class="public-hall__card"><span>Access later</span><strong>Private access stays intentional.</strong><p>When you are ready, Trust-Inme handles the private entry path with the right context.</p></article><article class="public-hall__card"><span>Clear lanes</span><strong>Public Hall is not Member Hall.</strong><p>Member status remains in the dashboard. Payment and confirmation flows stay in their own operational routes.</p></article></section></div></main></body></html>`;
  return new Response(request.method.toUpperCase() === "HEAD" ? null : html, { status: 200, headers: { "content-type": "text/html; charset=utf-8", "cache-control": "no-store, no-cache, must-revalidate, max-age=0", "x-mmd-worker": FRONT_GATE, "x-mmd-front-gate": FRONT_GATE, "x-mmd-front-version": FRONT_VERSION, "x-mmd-page": "public-hall", "x-mmd-route-owner": FRONT_GATE, "x-mmd-origin": "front-gate:public-hall" } });
}
...
export default {
  async fetch(request, env = {}) {
    ...
    if (isHallPath(url)) return renderPublicHallPage(request);
