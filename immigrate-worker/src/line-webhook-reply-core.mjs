...
// Migration preservation only. This provider-neutral reply/intent core is
// retained for future Cloudflare migration and is not a production webhook owner.
...
function buildAirtableRecordWithProfile(event, profile) {
  ...
  return {
    fields: {
      ...
      created_by: "line-slip-intake-preservation",
      source: "line",
