...
function isForbiddenModelFinanceKey(key) {
  ...
  return /(?:^|_)(?:payment_ref|provider(?:_|$)|slip(?:_|$)|bank(?:_|$)|margin(?:_|$)|commission(?:_|$)|settlement(?:_|$)|payout_evidence(?:_|$)|pricing_internal(?:_|$)|partner(?:_|$)|agency(?:_|$)|modeling(?:_|$)|rate(?:_|$)|fee(?:_|$)|cost(?:_|$)|customer_(?:total|amount|charge|spend)|amount_due|balance_due|remaining_balance|quoted_price|agreed_final_price|deposit(?:_|$)|pay_model(?:_|$)|model_payout_amount(?:_|$))/.test(normalized);
}
