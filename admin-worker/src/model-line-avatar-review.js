...
function candidateStatus(status){return /^active$/i.test(String(status||''))?'พร้อมเชื่อม':'ยังไม่พร้อมเชื่อม'}
