...
@media(max-width:767px){
  ...
  body[data-mms-admin-mb="v1"] .runtime{min-height:32px;padding:7px 10px;font-size:9px}
  ...
  body[data-mms-admin-mb="v1"] .hero-lead{margin-top:13px;font-size:13px;line-height:1.65}
  ...
  body[data-mms-admin-mb="v1"] .mms-diag-dock{right:10px;bottom:102px;min-height:44px;padding:10px 13px;font-size:10px}
  ...
  .mms-mb-title small{font-size:7px;font-weight:900;letter-spacing:.15em;color:#5c6f62;text-transform:uppercase}
  .mms-mb-title strong{font-size:12px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:#14231b}
  ...
  .mms-mb-lane small{display:block;color:#6a786f;font-size:8px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}
  .mms-mb-lane strong{display:block;margin-top:5px;font-size:13px}
  .mms-mb-lane b{font-size:27px;line-height:1;letter-spacing:-.04em}
  .mms-mb-lane.is-alert b{color:#8d3e38}
  .mms-mb-swipe-hint{display:block;margin:5px 2px 11px;color:#748178;font-size:9px;line-height:1.4}
