    ...
    <article class="access-card">
      ...
      <section class="panel" data-panel="owner">
        ...
        <form method="post" action="${ADMIN_LOGIN_SESSION_PATH}" id="ownerLoginForm" autocomplete="off">
          ...
          <label for="adminCredential">Access Code
            <span class="field"><input id="adminCredential" type="text" required readonly autocomplete="off" autocapitalize="none" autocorrect="off" spellcheck="false" inputmode="text" data-mask="true" data-1p-ignore="true" data-lpignore="true" data-bwignore="true" data-form-type="other" placeholder="Enter your access code"><button class="toggle" type="button" data-toggle="adminCredential" aria-pressed="false">SHOW</button></span>
          </label>
      ...
      <section class="panel partner-panel" data-panel="partner">
        ...
        <form id="partnerLoginForm" autocomplete="on">
          ...
          <label for="partnerUsername">Username<span class="field"><input id="partnerUsername" name="username" required autocomplete="username" autocapitalize="none" spellcheck="false" placeholder="Enter your username"></span></label>
          <label for="partnerPassword">Password<span class="field"><input id="partnerPassword" name="password" type="password" required minlength="12" maxlength="128" autocomplete="current-password" placeholder="Enter your password"><button class="toggle" type="button" data-toggle="partnerPassword" aria-pressed="false">SHOW</button></span></label>
        ...
        <section class="subpanel" data-subpanel="signup" hidden>
          <form id="partnerSignupForm" autocomplete="off">
            ...
            <label>Username<span class="field"><input name="username" required autocomplete="off" autocapitalize="none" spellcheck="false" placeholder="Create username"></span></label>
            <label>Password<span class="field"><input name="password" type="password" required minlength="12" maxlength="128" autocomplete="new-password" placeholder="Create password"></span></label>
            <label>Invite Code<span class="field"><input name="invite_code" type="password" required autocomplete="off" placeholder="Invite code"></span></label>
        ...
        <section class="subpanel" data-subpanel="recover" hidden>
          <form id="partnerRecoverForm" autocomplete="off">
            ...
            <label>Username<span class="field"><input name="username" required autocomplete="username" autocapitalize="none" spellcheck="false" placeholder="Username"></span></label>
            <label>Recovery Code<span class="field"><input name="recovery_code" type="password" required autocomplete="off" placeholder="Recovery code"></span></label>
            <label>New Password<span class="field"><input name="new_password" type="password" required minlength="12" maxlength="128" autocomplete="new-password" placeholder="New password"></span></label>
...
function loginHeaders() {
  return {
    ...
    "x-mmd-login-ui": "browser-fetch-v6",
