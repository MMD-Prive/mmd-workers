...
function projectStuckSlaWatch(value = null) {
  if (!value || value.available !== true) {
    return {
      ...
      counts: { total: 0, overdue: 0, watch: 0, owner_actionable_overdue: 0, owner_actionable_by_kind: {}, unavailable_sources: 6, unaged_records: 0, stale_terminal_records: 0, non_actionable_records: 0, by_kind: {} },
  ...
  return {
    ...
    counts: {
      ...
      owner_actionable_overdue: nn(counts.owner_actionable_overdue),
      ...
      non_actionable_records: nn(counts.non_actionable_records),
      by_kind: safeCountMap(counts.by_kind),
    },
    stale_terminal_by_kind: safeCountMap(value.stale_terminal_by_kind),
    non_actionable_by_kind: safeCountMap(value.non_actionable_by_kind),
