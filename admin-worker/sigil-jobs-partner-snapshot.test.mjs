...
test("partner settlement evidence keeps source rate separate from actual payout",()=>{
 const body={job_details:{partner_relationship:{settlement_method:"included_in_rate",partner_source_rate_thb:8000,model_payout_thb:5500,included_partner_amount_thb:2500}},partner_attribution:{partner_name:"Kendo"},pay_model_thb:5500};
