...
const P = { ref: "fldOO6SY49iDw8VBZ", received: "fld5rTIVEF1DXwfe2", date: "fld3yAwxIu2dkw7fO", verification: "fldJ7a0Ube9F0bmRy", officialAt: "fldPNK6qgxCSdaJRM", session: "fld2wdhBvc8xrV6y5" };
...
function pay(id, ref, amount, session, status = "official_verified", date = "2026-09-24") {
  return { id, fields: { [P.ref]: ref, [P.received]: amount, [P.session]: session, [P.date]: date, [P.verification]: status, [P.officialAt]: "2026-09-24T08:00:00Z" } };
}
