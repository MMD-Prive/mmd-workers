...
function html(body, nonce) {
  return new Response(body, { status:200, headers:{
    ...
    "content-security-policy":`default-src 'none'; script-src 'nonce-${nonce}' https://static.line-scdn.net; style-src 'nonce-${nonce}'; connect-src 'self'; img-src blob:; media-src blob:; base-uri 'none'; form-action 'none'; frame-ancestors 'none'`,
  }});
}
