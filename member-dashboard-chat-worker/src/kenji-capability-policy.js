...
const DETERMINISTIC_INTENTS = new Set([
  ...
  "per_continuity", "membership_signup", "private_membership_signup", "membership_renewal",
  "aftercare",
  "model_lookup", "model_access_verification",
  "vip", "svip", "black_card",
...
export function buildProtectedCapabilityReply(decision = {}) {
  ...
  if (domain === "payment") return "ผมจะไม่ยืนยันการชำระจากข้อความหรือสลิปอย่างเดียวครับ เปิดรายการชำระเงินเดิมที่ https://mmdbkk.com/member/payments ได้เลย ถ้ามี payment ref หรือส่งหลักฐานไว้แล้ว ไม่ต้องสร้างรายการหรือส่งหลักฐานซ้ำ รายการต้องผ่านการตรวจสอบอย่างเป็นทางการของ MMD ก่อนครับ";
  if (domain === "membership") return "ผมยังยืนยันสถานะ ระดับสมาชิก หรือวันหมดอายุจากข้อความนี้ไม่ได้ครับ ข้อมูลส่วนตัวต้องตรวจผ่าน My MMD ที่ยืนยันตัวตนสำเร็จก่อน";
  if (domain === "points") return "ผมยังยืนยันยอดแต้มและประวัติรายการจากข้อความนี้ไม่ได้ครับ ต้องตรวจจากข้อมูลสมาชิกและ Points Ledger ทางการก่อน";
