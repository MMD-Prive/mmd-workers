...
const MEMBER_MMS_PREFIX = "/member/api/mms/";
...
export default {
  async fetch(request, env = {}, ctx) {
    ...
    if (url.pathname.startsWith(MEMBER_LIFF_PREFIX) || url.pathname.startsWith(MEMBER_MMS_PREFIX) || MEMBER_LIFF_SHELL_PATHS.has(url.pathname)) {
