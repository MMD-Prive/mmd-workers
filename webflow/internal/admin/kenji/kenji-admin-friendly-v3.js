(function () {
  ...
  function mountHome() {
    ...
    home.insertAdjacentHTML("afterbegin", '<article class="kso-card"><span class="kso-kicker">Kenji Control Centre</span><h3>เลือกห้องที่ต้องใช้ตอนนี้</h3><p>ทุกอย่างของ Kenji อยู่ที่นี่แล้วครับ ไม่ต้องกลับไป SIGIL Board หรือหน้า AI แยก</p><div class="kso-hub"><button type="button" data-kso-board><b>SIGIL Board</b><small>ดูเคสที่ต้องตัดสินใจวันนี้</small></button><button type="button" data-kso-ai20><b>Kenji AI 2.0</b><small>ดูและลองหน้าที่สมาชิกเจอจริง</small></button><button type="button" data-tab="knowledge"><b>Knowledge</b><small>เปิดแก้, QA และดู Audit ย้อนหลัง</small></button></div></article>');
